...
public class TTSCHI extends AsyncTask<String, Void, String> {
    //TTS(NEW)
    String convertID;
    String SpeakURL;
    String methodName = "";
    ...
    public interface AsyncResponseCHI {
        void processFinishCHI(String output);
    }

    public AsyncResponseCHI delegate = null;

    public TTSCHI(AsyncResponseCHI delegate) {
    ...
    protected String doInBackground(String... params) {
        ...
        while (!isCancelled()) {
            ...
            isCancelled();
            String ID = GetIDName(BOTReturnWord, 0);
