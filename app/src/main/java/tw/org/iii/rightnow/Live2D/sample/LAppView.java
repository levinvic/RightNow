...
import tw.org.iii.rightnow.Live2D.framework.L2DMatrix44;
import tw.org.iii.rightnow.Live2D.framework.L2DTargetPoint;
import tw.org.iii.rightnow.Live2D.framework.L2DViewMatrix;
import tw.org.iii.rightnow.Live2D.android.AccelHelper;
import tw.org.iii.rightnow.Live2D.android.TouchManager;
...
public class LAppView extends GLSurfaceView {
	...
	private final SimpleOnGestureListener simpleOnGestureListener = new SimpleOnGestureListener()
	{
        ...
        {
        	float x=transformDeviceToViewX( touchMgr.getX() );
			Log.d("levinvic", "x"+String.valueOf(x));
    		float y=transformDeviceToViewY( touchMgr.getY() );
			Log.d("levinvic", "y="+String.valueOf(y));
